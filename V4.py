...
def panel_budget_report(
    ...
    with col_table1:
        ...
        <div class="pro-table-container">
            <div class="pro-table-header">Staffing Mix (Based on Naive Approach)</div>
    ...
    with col_table2:
        ...
        st.markdown("""
        <div class="pro-table-container">
            <div class="pro-table-header">Phase Allocation (Based on Selected Approach)</div>
            <div class="pro-table-body">
        """, unsafe_allow_html=True)
    ...
    with col_table3:
        ...
        st.markdown("""
        <div class="pro-table-container">
            <div class="pro-table-header">Pricing Summary (Based on Selected Approach)</div>
            <div class="pro-table-body">
        """, unsafe_allow_html=True)
